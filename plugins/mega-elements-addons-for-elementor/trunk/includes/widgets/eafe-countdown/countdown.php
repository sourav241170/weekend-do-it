...
class EAFE_Countdown extends Widget_Base
{

    public function get_name() {
        return 'eafe-countdown';
    }
    ...
    protected function _register_controls() 
    {
        ...
        $this->start_controls_section(
            'mefe_countdown_content_general_settings',
            [
         ...
         */ 
        $this->start_controls_section(
            'mefe_countdown_content_expire_settings',
            [
         ...
         */ 
        $this->start_controls_section(
            'mefe_countdown_content_text_settings',
            [
         ...
         */ 
        $this->start_controls_section(
            'mefe_countdown_style_block_style',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .eafe-countdown .pre_countdown-section' => 'background-color: {{VALUE}}'
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'      => '{{WRAPPER}} .eafe-countdown .pre_countdown-section',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units'    => ['px', '%', 'em'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-countdown .pre_countdown-section' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .eafe-countdown .pre_countdown-section' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .eafe-countdown .pre_countdown-section' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
         ...
         */ 
        $this->start_controls_section(
            'mefe_countdown_style_digits_style',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .eafe-countdown .pre_countdown-section .pre_countdown-amount' => 'color: {{VALUE}}'
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .eafe-countdown .pre_countdown-section .pre_countdown-amount',
                'separator' => 'after'
            ]
        );
         ...
         */ 
        $this->start_controls_section(
            'mefe_countdown_style_units_style',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .eafe-countdown .pre_countdown-section .pre_countdown-period' => 'color: {{VALUE}}'
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .eafe-countdown .pre_countdown-section .pre_countdown-period',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .eafe-countdown .pre_countdown-section' => 'margin-right: calc( {{SIZE}}{{UNIT}} / 2 ); margin-left: calc( {{SIZE}}{{UNIT}} / 2 )'
                ],
                'condition'     => [
                    'bccgs_countdown_separator!' => 'yes'
                ],
         ...
         */ 
        $this->start_controls_section(
            'mefe_countdown_style_separator_style', 
            [
    ...
    protected function render( ) {
        ...
        ?>
        <div id="countDownContiner-<?php echo esc_attr( $this->get_id() ); ?>" class="eafe-countdown-main eafe-countdown-separator-<?php echo $settings['bccgs_countdown_separator']; ?>" data-settings='<?php echo wp_json_encode( $countdown_settings ); ?>'>
            <div id="countdown-<?php echo esc_attr( $this->get_id() ); ?>" class="eafe-countdown-init eafe-countdown down"></div>
        </div>
        <?php
    }
