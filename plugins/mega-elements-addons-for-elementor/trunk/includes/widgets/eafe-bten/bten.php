...
class EAFE_BTEN extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        */ 
        $this->start_controls_section(
            'mefe_bten_content_general_settings',
            [
        ...
        */
        $this->start_controls_section(
            'mefe_bten_style_newsletter_title_style',
            [
        ...
        */ 
        $this->start_controls_section(
            'mefe_bten_style_form_field_style',
            [
        ...
        */
        $this->start_controls_section(
            'mefe_bten_style_sumbit_button_style',
            [
        ...
        $this->add_control(
            'bbssbs_bten_submit_border_color',
            [
    ...
    protected function render() {
        ...
        if ( ! empty( $settings['bbcgs_bten_form_id'] ) ) {
            echo do_shortcode( '[BTEN id=' . $settings['bbcgs_bten_form_id'] . ']');
        }
    }
