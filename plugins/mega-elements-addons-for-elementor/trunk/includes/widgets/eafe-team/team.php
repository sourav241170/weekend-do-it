...
class EAFE_Team extends Widget_Base
{
    ...
    protected function _register_controls() {
        ...
        */
        $this->start_controls_section(
            'mefe_team_content_content_settings',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block'   => true,
                'type'          => Controls_Manager::TEXT,
                'default'       => esc_html__( 'Manager', 'mega-elements-addons-for-elementor' ),
                'dynamic'       => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            'btccs_team_member_name_alignment',
            [
                'label'         => esc_html__( 'Name Alignment', 'mega-elements-addons-for-elementor' ),
                'type'          => Controls_Manager::CHOOSE,
                'options'       => [
                    'left'      => [
                        'title'     => esc_html__( 'Left', 'mega-elements-addons-for-elementor' ),
                ...
                'prefix_class'  => 'eafe-team-name-align-',
            ]
        );

        $this->add_control(
            'btccs_team_member_bio_alignment',
            [
                'label'         => esc_html__( 'Bio Alignment', 'mega-elements-addons-for-elementor' ),
                'type'          => Controls_Manager::CHOOSE,
                'options'       => [
                    'left'      => [
                        'title'     => esc_html__( 'Left', 'mega-elements-addons-for-elementor' ),
                ...
                'prefix_class'  => 'eafe-team-bio-align-',
            ]
        );

        $this->add_control(
            'btccs_team_member_social_alignment',
            [
                'label'         => esc_html__( 'Social Alignment', 'mega-elements-addons-for-elementor' ),
                'type'          => Controls_Manager::CHOOSE,
                'options'       => [
                    'left'      => [
                        'title'     => esc_html__( 'Left', 'mega-elements-addons-for-elementor' ),
                ...
                'prefix_class'  => 'eafe-team-social-align-',
                'separator'       => 'after',
            ]
        );
        ...
        */
        $this->start_controls_section(
            'mefe_team_content_social_settings',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'fields' => [
                    [
                        'name'      => 'btcss_team_member_social_new',
        ...
        */
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-figure img' => 'width: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-figure img' => 'height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-figure' => 'margin-bottom: {{SIZE}}{{UNIT}} !important',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-figure img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .eafe-member-figure img'
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-figure img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-figure img' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        */
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-name' => 'margin-bottom: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-name' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .eafe-member-name',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-position' => 'margin-bottom: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-position' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .eafe-member-position',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-bio' => 'margin-bottom: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-bio' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .eafe-member-bio',
            ]
        );
        ...
        */
        $this->start_controls_section(
            'mefe_team_style_social_profiles_styles',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-profiles .eafe-team-member-social-link' => 'font-size: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-profiles .eafe-team-member-social-link' => 'width: {{SIZE}}px',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-profiles .eafe-team-member-social-link' => 'height: {{SIZE}}px',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-profiles .eafe-team-member-social-link' => 'line-height: {{SIZE}}px',
                ],
            ]
        );
        ...
        $this->start_controls_tab( 
         ...
         $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-profiles .eafe-team-member-social-link:hover' => 'font-size: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-profiles .eafe-team-member-social-link:hover' => 'width: {{SIZE}}px',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-profiles .eafe-team-member-social-link:hover' => 'height: {{SIZE}}px',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-profiles .eafe-team-member-social-link:hover' => 'line-height: {{SIZE}}px',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .eafe-member-body > .eafe-team-member-social-profiles' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors'  => [
                    '{{WRAPPER}} .eafe-member-body > .eafe-team-member-social-profiles li.eafe-team-member-social-link' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-link' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-link' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .eafe-team-member-social-link',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-link' => 'border-radius: {{SIZE}}px',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-link:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-link:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .eafe-team-member-social-link:hover' => 'border-color: {{VALUE}}',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'btccs_team_member_title', 'class', 'eafe-member-name' );

        $this->add_inline_editing_attributes( 'btccs_team_member_job_title', 'basic' );
        $this->add_render_attribute( 'btccs_team_member_job_title', 'class', 'eafe-member-position' );

        $this->add_inline_editing_attributes( 'btccs_team_member_bio', 'intermediate' );
        $this->add_render_attribute( 'btccs_team_member_bio', 'class', 'eafe-member-bio' );
        ?>

        <?php if ( $settings['btccs_team_member_image']['url'] || $settings['btccs_team_member_image']['id'] ) : ?>
            <figure class="eafe-member-figure">
                <?php echo Group_Control_Image_Size::get_attachment_image_html( $settings, 'btccs_team_member_thumbnail', 'btccs_team_member_image' ); ?>
            </figure>
        <?php endif; ?>

        <div class="eafe-member-body">
            <?php if ( $settings['btccs_team_member_title'] ) :
                printf( '<%1$s %2$s>%3$s</%1$s>',
                    $settings['btccs_team_member_title_tag'],
                    $this->get_render_attribute_string( 'btccs_team_member_title' ),
                    $settings['btccs_team_member_title']
                );
            endif; ?>

            <?php if ( $settings['btccs_team_member_job_title' ] ) : ?>
                <div <?php $this->print_render_attribute_string( 'btccs_team_member_job_title' ); ?>><?php echo $settings['btccs_team_member_job_title' ]; ?></div>
            <?php endif; ?>

            <?php if ( $settings['btccs_team_member_bio'] ) : ?>
                <div <?php $this->print_render_attribute_string( 'btccs_team_member_bio' ); ?>>
                    <p><?php echo $settings['btccs_team_member_bio']; ?></p>
                </div>
            <?php endif; ?>
            
            <?php if ( ! empty( $settings['btcss_team_member_enable_social_profiles'] ) ): ?>
                <ul class="eafe-team-member-social-profiles">
                    <?php foreach ( $settings['btcss_team_member_social_profile_links'] as $item ) : ?>
                        ...
                        <?php if ( ! empty( $item['btcss_team_member_social'] ) || !empty( $item['btcss_team_member_social_new'] ) ) : ?>
                            ...
                            <li class="eafe-team-member-social-link">
                                <?php if ( ! empty( $item['btcss_team_member_link'] ) && $item['btcss_team_member_link']['url'] ) : ?>
                                    <a href="<?php echo esc_attr( $item['btcss_team_member_link']['url'] ); ?>" <?php echo $target; ?>>
                                <?php endif; ?>
                                    <?php if ( $icon_is_new || $icon_migrated ) { ?>
                                        <?php if( isset( $item['btcss_team_member_social_new']['value']['url'] ) ) : ?>
                                            <img src="<?php echo esc_attr( $item['btcss_team_member_social_new']['value']['url'] ); ?>" alt="<?php echo esc_attr( $item['btccs_team_member_title'] ); ?>" />
                                        <?php else : ?>
    ...
    public function _content_template() {
        ...
        view.addRenderAttribute( 'btccs_team_member_title', 'class', 'eafe-member-name' );

        view.addInlineEditingAttributes( 'btccs_team_member_job_title', 'basic' );
        view.addRenderAttribute( 'btccs_team_member_job_title', 'class', 'eafe-member-position' );

        view.addInlineEditingAttributes( 'btccs_team_member_bio', 'intermediate' );
        view.addRenderAttribute( 'btccs_team_member_bio', 'class', 'eafe-member-bio' );
        ...
        <div class="eafe-member-body">
            <# if (settings.btccs_team_member_title) { #>
                <{{ settings.btccs_team_member_title_tag }} {{{ view.getRenderAttributeString( 'btccs_team_member_title' ) }}}>{{ settings.btccs_team_member_title }}</{{ settings.btccs_team_member_title_tag }}>
            <# } #>
            ...
            <# } #>
            <# if (settings.btccs_team_member_bio) { #>
