...
class EAFE_Category extends Widget_Base
{

    public function get_name() {
        return 'eafe-category';
    }
    ...
    protected function query_controls()
    {
        ...
        */
        ...
        $this->start_controls_section(
            'mefe_category_content_query_settings',
            [
    ...
    protected function layout_controls()
    {
        ...
        */
        $this->start_controls_section(
            'mefe_category_content_layout_settings',
            [
    ...
    protected function _register_controls()
    {
         ...
         */
        $this->start_controls_section(
            'mefe_category_style_general_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'     => ['gradient'],
                'selectors' => [
                    '{{WRAPPER}} .eafe-categories-wrap .title-wrapper' => 'background: {{VALUE}}',
                ],
                'exclude'   => [
                    'image',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .eafe-categories-wrap .title-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .eafe-categories-wrap .title-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .eafe-categories-meta-wrap li a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .eafe-categories-meta-wrap li a' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px',
                ],
            ]
        );
         ...
         */
        $this->start_controls_section(
            'mefe_category_style_color_typography_style',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .eafe-entry-title, {{WRAPPER}} .ba-category-one .eafe-entry-title' => 'color: {{VALUE}}',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .eafe-entry-title:hover, {{WRAPPER}} .ba-category-one .eafe-entry-title:hover' => 'color: {{VALUE}}',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-entry-title' => 'text-align: {{VALUE}}',
                    '{{WRAPPER}} .eafe-entry-meta' => 'text-align: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .eafe-entry-meta, {{WRAPPER}} .ba-category-one .eafe-entry-meta' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .eafe-entry-meta',
            ]
        );
    ...
    public function render_category_template( $settings )
    {
        ...
        echo '<div class="eafe-categories-wrap">';
        echo '<ul class="eafe-categories-meta-wrap">';
        ...
        foreach ( $cats as $key => $value ) 
        {
            ...
            if( $category )
            {
                ...
                if( $settings['bccls_category_show_image'] && isset( $img ) && is_array( $img ) && isset( $img[0] ) && $img[0] !='' )
                {
                    ...
                    echo '<a '.$target.' href="'. esc_url( get_category_link( $value ) ) .'"><img src="' . esc_url( $url1 ) . '" alt="'. get_cat_name( $value ) .'"><div class="title-wrapper"><span class="eafe-entry-title">'.get_cat_name( $value ).'</span>';
                    if( $settings['bccls_category_show_meta'] && $count > 0 ) {
                        echo '<span class="eafe-entry-meta">'.esc_html( $count ).__(' Post(s)','mega-elements-addons-for-elementor').'</span>';
                    }
                ...
                {
                    $image_size = mefe_get_image_sizes( $ccw_img_size );
                    ...
                    echo '<a '.$target.' href="'. esc_url( get_category_link( $value ) ) .'">' . $url1 . '<div class="title-wrapper"><span class="eafe-entry-title">'.get_cat_name( $value ).'</span>';
                    if( $settings['bccls_category_show_meta'] && $count > 0 ) {
                        echo '<span class="eafe-entry-meta">'.esc_html( $count ).__(' Post(s)','mega-elements-addons-for-elementor').'</span>';
                    }
                    echo '</div></a></li>';
    ...
    protected function render()
    {
        ...
        echo '<div ' . $this->get_render_attribute_string( 'category_wrapper' ) . '>
            <div class="eafe-post-grid eafe-post-appender eafe-post-appender-' . $this->get_id() . '">
