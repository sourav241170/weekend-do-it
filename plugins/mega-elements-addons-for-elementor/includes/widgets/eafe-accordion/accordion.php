...
class EAFE_Accordion extends Widget_Base
{

    public function get_name() {
        return 'eafe-accordion';
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            'mefe_accordion_content_general_settings',
            [
         ...
         */
        $this->start_controls_section(
            'mefe_accordion_content_content_settings',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'fields'    => [
                    [
                        'name'          => 'bacccs_accordion_tab_default_active',
                    ...
                    [
                        'name'          => 'bacccs_accordion_tab_title',
                    ...
                    [
                        'name'          => 'bacccs_accordion_tab_content',
         ...
         */
        $this->start_controls_section(
            'mefe_accordion_style_general_style',
            [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector'      => '{{WRAPPER}} .eafe-accordion',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        $this->add_group_control(
         ...
         */
        $this->start_controls_section(
            'mefe_accordion_style_tab_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header span.blsm-default-icon' => 'font-size: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header span.blsm-active-icon' => 'font-size: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'          => Controls_Manager::SLIDER,
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-header .blsm-default-icon' => 'left: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-header .blsm-active-icon' => 'left: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'          => Controls_Manager::SLIDER,
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-header .blsm-default-icon' => 'top: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-header .blsm-active-icon' => 'top: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       => '',
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header span.blsm-title' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'       => '',
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header span.blsm-default-icon' => 'color: {{VALUE}}','{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header span.blsm-active-icon' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'         => ['classic', 'gradient'],
                'selector'      => '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header:hover',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'       => '',
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header .blsm-title:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'       => '',
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header span.blsm-default-icon:hover' => 'color: {{VALUE}}','{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header span.blsm-active-icon:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'         => ['classic', 'gradient'],
                'selector'      => '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header.active',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-header.active' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        $this->end_controls_tab();
         ...
         */
        $this->start_controls_section(
            'mefe_accordion_style_content_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'         => ['classic', 'gradient'],
                'selector'      => '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-content',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       => '',
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-content' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', 'em', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .eafe-accordion .eafe-accordion-list .eafe-accordion-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        $this->add_group_control(
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute( 'eafe-accordion', 'class', 'eafe-accordion' );
        $this->add_render_attribute( 'eafe-accordion', 'id', 'eafe-accordion-' . esc_attr( $this->get_id() ) );
        ?>
        <div
            <?php echo $this->get_render_attribute_string( 'eafe-accordion' ); ?>
		...
		<?php foreach ( $settings['bacccs_accordion_tab'] as $index => $tab ) {
            ...
            $tab_title_class = ['elementor-tab-title', 'eafe-accordion-header'];
            $tab_content_class = ['eafe-accordion-content', 'clearfix'];
            ...
            echo '<div class="eafe-accordion-list">
                <div ' . $this->get_render_attribute_string( $tab_title_setting_key ) . '>
                    <span>';
                        ...
                        <?php }
                        echo '<span class="blsm-title">' . $tab['bacccs_accordion_tab_title'] . '</span>' .
                    '</span>';
                echo '</div>';
