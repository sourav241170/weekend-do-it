		...
		<div class="class-wte-advanced-search-wrapper wte-advanced-search-wrapper-nice-select">
			...
			<div class="advanced-search-field trip-duration">
				...
				<div class="advanced-search-field search-dur">
					<div data-suffix="<?php echo esc_attr__( 'Days', 'wp-travel-engine' ); ?>" data-range='<?php echo esc_attr( wp_json_encode( $duration_range ) ); ?>' data-target-show="[data-search-duration-value]" id="sform-duration-slider-range"></div>
					<div class="duration-slider-value">
						<span class="min-duration" id="min-duration" name="min-duration"><?php echo sprintf( esc_html__( '%d Days', 'wp-travel-engine' ), esc_html( round( $min_duration ) ) ); ?></span>
						<span class="max-duration" id="max-duration" name="max-duration"><?php echo sprintf( esc_html__( '%d Days', 'wp-travel-engine' ), esc_html( round( $max_duration ) ) ); ?></span>
					</div>
				</div>
			...
			<div class="advanced-search-field trip-cost">
				...
				<div class="advanced-search-field search-price">
					...
					<div class="cost-slider-value">
						...
						<span class="max-cost" id="max-cost" name="max-cost"><?php echo wte_esc_price( wte_get_formated_price_html( $max_cost ) ); ?></span>
					</div>
				</div>
