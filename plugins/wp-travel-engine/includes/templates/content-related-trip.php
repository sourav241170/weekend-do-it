...
echo $related_new_trip_listing ? ' wpte_new-layout' : '';
?>
		...
		<div class="category-trip-content-wrap">
			<div class="category-trip-prc-title-wrap">
				...
				if ( $show_related_wishlist ) {
					...
					<a class="wishlist-toggle<?php echo esc_attr( $active_class ); ?>" data-product="<?php echo esc_attr( $post->ID ); ?>" href="#" title="<?php echo esc_attr( $title_attribute ); ?>">
			...
			<div class="category-trip-detail-wrap">
				...
				<?php
				if ( ( isset( $settings['related_display_new_trip_listing'] ) && 'yes' !== $settings['related_display_new_trip_listing'] ) || ! $show_related_date_layout ) :
					if ( $show_excerpt ) :
						?>
					<div class="category-trip-desc">
						<?php wptravelengine_the_trip_excerpt(); ?>
