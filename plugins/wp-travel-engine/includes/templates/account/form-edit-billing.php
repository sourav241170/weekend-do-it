...
?>
	<form method="post" class="wpte-lrf-form">
		...
		<div class="wpte-lrf-field lrf-text">
			<label class="lrf-field-label" for="lrf-address"><?php esc_html_e( 'Address:', 'wp-travel-engine' ); ?><span
		...
		<div class="wpte-lrf-field lrf-number">
			<label class="lrf-field-label"
				   for="customer_zip_code"><?php esc_html_e( 'Zip/Postal Code:', 'wp-travel-engine' ); ?><span
					class="required">*</span></label>
			<input type="number" name="customer_zip_code" id="customer_zip_code" required="1"
				   data-msg="Please enter zip code" data-parsley-required-message="Please enter zip code"
				   value="<?php echo esc_attr( $billing_zip ); ?>" />
		</div>

		<div class="wpte-lrf-field lrf-text">
			<label class="lrf-field-label" for="lrf-country"><?php esc_html_e( 'Country:', 'wp-travel-engine' ); ?><span
					class="required">*</span></label>
			<select id="lrf-country" class="selectpicker form-control" name="customer_country" required="1"
		...
		<div class="wpte-lrf-field lrf-tel">
			<label class="lrf-field-label" for="lrf-phone"><?php esc_html_e( 'Phone Number:', 'wp-travel-engine' ); ?>
				<span class="required">*</span></label>
			<input type="number" name="customer_phone" id="lrf-phone" required="1"
