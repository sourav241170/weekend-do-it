			...
			<div id="wteProcessTabs" class="wte-process-container">
				...
				<div class="wte-process-tab-controller">
					...
					<button type="button" id="wteProcessNext" disabled data-step="1"
							...
							data-label-default="<?php echo esc_attr__( 'Continue', 'wp-travel-engine' ); ?>"
							data-label-checkout="<?php echo esc_attr__( 'Proceed to checkout', 'wp-travel-engine' ); ?>"><?php esc_html_e( 'Continue', 'wp-travel-engine' ); ?></button>
				</div>
			</div>
		</div>
