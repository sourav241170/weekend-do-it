		...
		<div class="obp-process-content-outer">
			<div class="obp-process-content-inner">
				<div class="obp-process-content obp-getting-started-content current" id="obp-homepage">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'page' => 'wptravelengine-admin-page' ), admin_url( 'admin.php' ) ) ); ?>" class="obp-btn-link"><?php esc_html_e( 'Return to dashboard', 'wp-travel-engine' ); ?></a>
				</div>
					...
					<div class="wpte-block">
						...
						$pages         = array(
							...
							'wte-wishlist-page'     => array(
								...
								'selected' => isset( $wp_travel_engine_tabs['pages']['wp_travel_engine_wishlist'] ) ? esc_attr( $wp_travel_engine_tabs['pages']['wp_travel_engine_wishlist'] ) : wptravelengine_get_page_by_title( 'Wishlist' )->ID,
				...
				<div class="obp-process-content obp-payment-content" id="obp-payment-gateway-setting">
					...
					<div class="wpte-block">
						...
						<div class="wpte-info-block">
							...
							<a href="https://wptravelengine.com/plugins/category/payment-gateways/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro" target="_blank" class="wpte-btn wpte-btn-transparent"><?php esc_html_e( 'Get Premium Gateways', 'wp-travel-engine' ); ?></a>
						</div>
					</div>
				</div>
				<?php
			...
			<div class="obp-footer">
				<div class="wpte-left-block">
					...
					<?php
					$wptravelengine_admin_url = add_query_arg(
						array(
							'post_type' => 'booking',
							'page'      => 'wptravelengine-admin-page',
						),
						admin_url( 'edit.php' )
					);
					?>
					<a href="<?php echo esc_url( $wptravelengine_admin_url ); ?>" class="obp-btn-link obp-hide"><?php esc_html_e( 'Go to Dashboard', 'wp-travel-engine' ); ?></a>
				</div>
