			...
			<div class="wrap">
				...
				<div class="wpte-booking-inner-wrapper">
					...
					if ( true || wte_array_get( $wte_options, 'show_multiple_pricing_list_disp', '' ) == '1' ) :
						...
						if ( $wtetrip->has_sale ) :
							?>
							<span
								class="wpte-bf-discount-tag"><?php echo sprintf( esc_html__( '%d%% Off', 'wp-travel-engine' ), (float) $wtetrip->sale_percentage ); ?></span>
						<?php
						endif;
						?>
				...
				<?php if ( empty( $settings[ 'enquiry' ] ) ) : ?>
					<div class="wpte-booking-footer-text">
						<span><?php esc_html_e( 'Need help with booking?', 'wp-travel-engine' ); ?></span> <a
							href="#wte_enquiry_form_scroll_wrapper"
							id="wte-send-enquiry-message"><?php esc_html_e( 'Send Us A Message', 'wp-travel-engine' ); ?></a>
					</div>
				<?php
				endif;
