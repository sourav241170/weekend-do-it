			...
			if ( $title || $content ) {
				?>
					<header class="section-header">
						<?php
						if ( $title ) {
							echo '<h2 class="section-title">' . esc_html( travel_booking_toolkit_get_deal_title() ) . '</h2>';
						}
						if ( $content ) {
							echo '<div class="section-content">' . wp_kses_post( travel_booking_toolkit_get_deal_content() ) . '</div>';
						}
						?>
					</header>
					<?php
									...
									<div class="col-holder">
										<div class="img-holder">
											...
											<div class="price-info">
												...
												$obj->travel_booking_toolkit_trip_symbol_options( get_the_ID() );
												?>
											</div>
										</div>
											...
											<div class="trip-info">
												...
												if ( isset( $meta['trip_duration'] ) && '' != $meta['trip_duration'] ) {
													...
													$duration_unit_mapping = array(
														'days'   => array( __( 'Day', 'travel-booking-toolkit' ), __( 'Days', 'travel-booking-toolkit' ) ),
