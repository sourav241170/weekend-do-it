...
if( ! class_exists( 'Travel_Booking_Toolkit_Control_Repeater' ) ) {
    /**
     * Repeater control
     */
    class Travel_Booking_Toolkit_Control_Repeater extends WP_Customize_Control {
    	...
    	protected function l10n( $id = false ) {
    		$translation_strings = array(
    			'row'               => esc_attr__( 'row', 'travel-booking-toolkit' ),
    			'add-new'           => esc_attr__( 'Add new', 'travel-booking-toolkit' ),
    			'select-page'       => esc_attr__( 'Select a Page', 'travel-booking-toolkit' ),
    			'limit-rows'        => esc_attr__( 'Limit: %s rows', 'travel-booking-toolkit' ),
    			'hex-value'         => esc_attr__( 'Hex Value', 'travel-booking-toolkit' ),
    			'no-image-selected' => esc_attr__( 'No Image Selected', 'travel-booking-toolkit' ),
    			'remove'            => esc_attr__( 'Remove', 'travel-booking-toolkit' ),
    			'add-image'         => esc_attr__( 'Add Image', 'travel-booking-toolkit' ),
    			'change-image'      => esc_attr__( 'Change Image', 'travel-booking-toolkit' ),
    			'no-file-selected'  => esc_attr__( 'No File Selected', 'travel-booking-toolkit' ),
    			'add-file'          => esc_attr__( 'Add File', 'travel-booking-toolkit' ),
    			'change-file'       => esc_attr__( 'Change File', 'travel-booking-toolkit' ),
    		);
    		$translation_strings = apply_filters( 'rara/repeater/l10n', $translation_strings );
    		if ( false === $id ) {
