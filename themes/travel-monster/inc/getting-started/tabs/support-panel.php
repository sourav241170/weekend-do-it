...
<div id="support-panel" class="panel-left">
    ...
    <div class="toggle-block">
		...
		<div class="toggle-content">
			...
			?></p>
			<p><?php printf( __( 'If this didn\'t help, please %1$sContact Support%2$s.', 'travel-monster' ), '<a href="'. esc_url( 'https://wptravelengine.com/support-ticket/?utm_source=travel_monster&utm_medium=dashboard&utm_campaign=support' ) .'" target="_blank">', '</a>' ); ?></p>
		</div>
	</div>
